...
export const en = {
  ...
  useCaseDetails: {
    ...
    contract: {
      ...
      assumptionsTitle: "We assume the following:",
      assumption1: "Provision of necessary hardware and software by the customer.",
      assumption2: "Access to customer administration tools.",
      assumption3: "Provision of documentation and instructions.",
      assumption4: "Provision of workspace if required.",
      assumption5: "Onboarding must not exceed 5 working days.",
      scopeLimits: "Scope limits:",
      scopeLimit1: "Implementation of up to 5 Agents",
      scopeLimit2: "Implementation of up to 5 Workflows",
      scopeLimit3: "Integration of up to 5 Interfaces",

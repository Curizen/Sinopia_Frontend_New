...
export const en = {
  ...
  useCaseDetails: {
    ...
    comingSoonDate: "",
    contract: {
      sectionTitle: "Contract Offer",
      offerNo: "Offer No.",
      greeting: "Dear Sir or Madam,",
      intro: "Thank you for your inquiry. We are pleased to submit the following offer regarding your inquiry for Use Case No.",
      managementSummary: "Management Summary",
      implementationPhases: "Implementation Phases & Milestones",
      scopeOfServices: "Scope of Services",
      requiredSkillsRoles: "Required Skills & Roles",
      prerequisites: "Prerequisites & Assumptions",
      prerequisitesIntro: "To ensure the success of the project, the following prerequisites apply:",
      clientEnvironment: "Client Environment:",
      companySizeLabel: "Company Size",
      companySizeSuffix: "employees.",
      industryLabel: "Industry",
      clientObligations: "Client Obligations:",
      obligationProvisioning: "Provisioning: The customer shall provide necessary hardware, software, and access authorizations required for service delivery.",
      obligationAccess: "Access: Remote access to administration/management tools.",
      obligationDocumentation: "Documentation: Availability of relevant work instructions and legacy documentation.",
      obligationFacilities: "Facilities (if on-site): Workspaces, internet access, and necessary authorizations.",
      obligationOnboarding: "Onboarding: Must not exceed 5 working days from the start date.",
      serviceHours: "Service Hours",
      serviceHoursText: "Monday – Friday, 06:00 – 20:00 (excluding public holidays)",
      workingDay: "Working day: 8 hours + 30 minute break",
      travelExpenses: "Travel Expenses",
      travelExpensesText: "Travel expenses such as transportation, accommodation, and meals are billed separately based on actual receipts.",
      paymentPlan: "Payment Plan",
      invoiceNote: "Invoices payable within 7 days.",
      acceptance: "Acceptance",
      offerValidUntil: "This offer expires on",
  ...
  profile: {
    ...
    companyInfoSectionMain: "General",
    companyInfoSectionContact: "Contact",
    companyInfoSectionLocation: "Location",
    companyInfoSectionLegal: "Legal",
...
Developed by the specialists for LegalTech at Willing & Able that also developed the system for GDPR vacation tracker. The legal texts contained in our privacy policy generator have been provided and published by Prof. Dr. h.c. Heiko Jonny Maniero from the German Association for Data Protection and Christian Solmecke from WBS law.`,
  ...
  useCases: {
    ...
    estimationSectionTitle: "Project Estimation",
    durationMonthsLabel: "Project Duration (Months)",
    teamSizeLabel: "Team Size",
    engagementTypeLabel: "Engagement Type",
    engagementFullTime: "Full-Time (160 hours/month)",
    engagementPartTime: "Part-Time / Fractional",

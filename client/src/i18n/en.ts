...
export const en = {
  ...
  home: {
    ...
    feature1Desc:
      "Our smart matching algorithm connects you with the right Use Cases or talents based on your skills and requirements.",
    ...
    feature3Desc:
      "Legally binding digital contracts that protect both skill givers and searchers throughout the Use Case.",
    ...
    testimonials: {
      ...
      mock: {
        ...
        person1Quote:
          "Sinopia has transformed my freelance career. I found consistent high-quality Use Cases and doubled my income within 6 months.",
  ...
  auth: {
    ...
    skillGiverDesc: "I want to offer my skills and find Use Cases",
  ...
  contracts: {
    ...
    signContractDesc:
      'You are about to sign the contract for "{Use Case Title}". This will make the contract legally binding.',
  ...
  profile: {
    ...
    personalProjects: "Personal Use Cases",
    mock: {
    ...
    projectUpdated: "Use Case updated successfully",
    projectDeleted: "Use Case deleted successfully",
    confirmDeleteProject: "Are you sure you want to delete this Use Case?",
    projectUrl: "Use Case URL",
    projectUrlPlaceholder: "e.g., https://github.com/username/Use Case",
    deleteFailed: "Failed to delete",
    addProject: "Add Use Case",
    projectName: "Use Case Name",
    projectNamePlaceholder: "Name of your Use Case",
  ...
  features: {
    ...
    skillSearchersDesc:
      "Companies seeking precise expertise for tasks, processes, or Use Cases.",
    ...
    sg1Desc:
      "Bring your lifelong knowledge into meaningful, flexible Use Cases.",
    ...
    step1Desc:
      "Create your profile and outline your skills or submit your Use Case as a clear Use Case.",
  ...
  emptyState: {
    ...
    noPersonalProjects: "No personal Use Cases added",
  },
  status: {
    paid: "Paid",
    pending: "Pending",
  ...
  useCases: {
    ...
    projectStages: "Use Cases Stages",
    analyzeHint: "Click 'Analyze Use Case' to get AI-powered insights before creating.",
    projectOverview: "Use Cases Overview",
    projectSummary: "Use Cases Summary",

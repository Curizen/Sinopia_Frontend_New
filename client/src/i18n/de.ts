...
export const de = {
  ...
  profile: {
    ...
    cvUploadDescription: "Laden Sie Ihren Lebenslauf hoch und lassen Sie die KI automatisch Ihre Fähigkeiten, Erfahrung und Ausbildung extrahieren.",
    cvUploadButton: "Lebenslauf hochladen & mit KI auslesen",
    ...
    cvExtractionComplete: "Ihr Profil wurde mit den extrahierten Informationen aktualisiert.",
    cvExtractionFailed: "Nicht alle Informationen konnten extrahiert werden. Du kannst sie manuell bearbeiten.",
    cvInvalidFileType: "Bitte laden Sie ein PDF- oder Word-Dokument hoch.",
    cvFileTooLarge: "Bitte laden Sie eine Datei kleiner als 5MB hoch.",
  },
  footer: {
    skillGiver: "Fähigkeitengeber",

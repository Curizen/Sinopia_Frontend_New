...
export const de = {
  ...
  useCaseDetails: {
    ...
    perHour: "Std.",
    acceptUseCase: "Angebot generieren",
    reject: "Ablehnen",
    comingSoonTitle: "Demnächst verfügbar",
    comingSoonBody: "",
    comingSoonDate: "",
    contract: {
      sectionTitle: "Vertragsangebot",
      offerNo: "Angebots-Nr.",
      greeting: "Sehr geehrte Damen und Herren,",
      intro: "vielen Dank für Ihre Anfrage. Wir freuen uns, Ihnen folgendes Angebot bezüglich Ihrer Anfrage für Anwendungsfall Nr.",
      managementSummary: "Management-Zusammenfassung",
      implementationPhases: "Implementierungsphasen & Meilensteine",
      scopeOfServices: "Leistungsumfang",
      requiredSkillsRoles: "Erforderliche Fähigkeiten & Rollen",
      prerequisites: "Voraussetzungen & Verpflichtungen",
      prerequisitesIntro: "Um den Erfolg des Projekts sicherzustellen, gelten folgende Voraussetzungen:",
      clientEnvironment: "Kundenumgebung:",
      companySizeLabel: "Unternehmensgröße",
      companySizeSuffix: "Mitarbeiter.",
      industryLabel: "Branche",
      clientObligations: "Kundenverpflichtungen:",
      obligationProvisioning: "Bereitstellung: Der Kunde stellt die notwendige Hardware, Software und Zugriffsberechtigungen für die Leistungserbringung bereit.",
      obligationAccess: "Zugang: Fernzugriff auf Verwaltungs- und Managementwerkzeuge.",
      obligationDocumentation: "Dokumentation: Verfügbarkeit relevanter Arbeitsanweisungen und bestehender Dokumentation.",
      obligationFacilities: "Einrichtungen (bei Vor-Ort-Einsatz): Arbeitsplätze, Internetzugang und erforderliche Berechtigungen.",
      obligationOnboarding: "Onboarding: Darf 5 Arbeitstage ab Startdatum nicht überschreiten.",
      serviceHours: "Servicezeiten",
      serviceHoursText: "Montag – Freitag, 06:00 – 20:00 Uhr (außer Feiertage)",
      workingDay: "Arbeitstag: 8 Stunden + 30 Minuten Pause",
      travelExpenses: "Reisekosten",
      travelExpensesText: "Reisekosten wie Transport, Unterkunft und Verpflegung werden separat nach tatsächlichem Beleg abgerechnet.",
      paymentPlan: "Zahlungsplan",
      invoiceNote: "Rechnungen sind innerhalb von 7 Tagen zahlbar.",
      acceptance: "Annahme",
      offerValidUntil: "Dieses Angebot läuft ab am",
      offerDate: "Angebotsdatum",
      salesPerson: "Ansprechpartner",
      contactUs: "Kontakt",
    },
  },
  projectDetail: {
  ...
  profile: {
    ...
    companyInfoSectionMain: "Allgemein",
    companyInfoSectionContact: "Kontakt",
    companyInfoSectionLocation: "Standort",
    companyInfoSectionLegal: "Rechtliches",
...
Entwickelt von den Spezialisten f\u00FCr LegalTech bei Willing & Able, die auch das System f\u00FCr den DSGVO-Urlaubstracker entwickelt haben. Die in unserem Datenschutzerkl\u00E4rungsgenerator enthaltenen Rechtstexte wurden von Prof. Dr. h.c. Heiko Jonny Maniero vom Deutschen Datenschutzverband und Christian Solmecke von WBS law bereitgestellt und ver\u00F6ffentlicht.`,
  ...
  useCases: {
    ...
    estimationSectionTitle: "Projektschätzung",
    durationMonthsLabel: "Projektdauer (Monate)",
    teamSizeLabel: "Teamgröße",
    engagementTypeLabel: "Einsatzmodell",
    engagementFullTime: "Vollzeit (160 Stunden/Monat)",
    engagementPartTime: "Teilzeit / Fraktioniert",
    daysPerWeekLabel: "Tage pro Woche",
    hoursPerDayLabel: "Stunden pro Tag",

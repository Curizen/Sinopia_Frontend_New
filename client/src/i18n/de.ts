...
export const de = {
  ...
  about: {
    ...
    skill1Name: "Experten-Matching",
    skill1Desc: "Verbindung der richtigen Fachleute mit spezifischen Use Cases basierend auf verifizierter Expertise.",
    ...
    skill6Name: "Experten-Onboarding",
  ...
  useCases: {
    uploadUseCase: "Use Case hochladen",
    postUseCase: "Use Case erstellen",
    uploadTitle: "Use Case hochladen",
    uploadSubtitle: "Laden Sie ein PDF- oder Word-Dokument hoch, das Ihren Use Case beschreibt",
    ...
    filesProcessedDesc: "Ihr Use Case wurde zur Überprüfung eingereicht.",
    submitUpload: "Use Case einreichen",
    postTitle: "Use Case erstellen",
    postSubtitle: "Erstellen Sie einen neuen Use Case, um den richtigen Experten zu finden",
    details: "Use Case Details",
    titleLabel: "Titel",
    titlePlaceholder: "z.B. Prozessoptimierung in der Fertigung",
    descriptionLabel: "Beschreibung",
    descriptionPlaceholder: "Beschreiben Sie Ihren Use Case im Detail. Wie ist die aktuelle Situation? Welche Herausforderungen gibt es?",
    objectiveLabel: "Ziel",
    objectivePlaceholder: "Was möchten Sie erreichen? Was ist das gewünschte Ergebnis?",
    objective: "Ziel",
    createButton: "Use Case erstellen",
    created: "Use Case erstellt!",
    createdDesc: "Ihr Use Case wurde erfolgreich veröffentlicht.",

...
export const de = {
  ...
  useCaseDetails: {
    ...
    contract: {
      ...
      prerequisites: "Voraussetzungen & Annahmen",
      companySizeLabel: "Unternehmensgröße",
      industryLabel: "Branche",
      assumptionsTitle: "Wir gehen von folgenden Voraussetzungen aus:",
      assumption1: "Bereitstellung der notwendigen Hard- und Software durch den Kunden.",
      assumption2: "Zugang zu den Verwaltungstools des Kunden.",
      assumption3: "Bereitstellung von Dokumentation und Anweisungen.",
      assumption4: "Bereitstellung eines Arbeitsplatzes, falls erforderlich.",
      assumption5: "Das Onboarding darf 5 Arbeitstage nicht überschreiten.",
      scopeLimits: "Umfangsgrenzen:",
      scopeLimit1: "Implementierung von bis zu 5 Agenten",
      scopeLimit2: "Implementierung von bis zu 5 Workflows",
      scopeLimit3: "Integration von bis zu 5 Schnittstellen",

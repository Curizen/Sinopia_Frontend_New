...
export const de = {
  ...
  privacy: {
    ...
    introductionText: "Die curizen GmbH, Leopoldstr. 36, 40211 Düsseldorf (nachfolgend \"Betreiber\" genannt), als Betreiber dieser Website nimmt den Schutz Ihrer persönlichen Daten sehr ernst. Wir behandeln Ihre personenbezogenen Daten vertraulich und entsprechend der gesetzlichen Datenschutzvorschriften sowie dieser Datenschutzerklärung. Die Nutzung unserer Website ist grundsätzlich ohne Angabe personenbezogener Daten möglich. Soweit auf unseren Seiten personenbezogene Daten (z.B. Name, Anschrift oder E-Mail-Adressen) erhoben werden, erfolgt dies, soweit möglich, stets auf freiwilliger Basis. Diese Daten werden ohne Ihre ausdrückliche Zustimmung nicht an Dritte weitergegeben. Wir weisen darauf hin, dass die Datenübertragung im Internet (z.B. bei der Kommunikation per E-Mail) Sicherheitslücken aufweisen kann. Ein lückenloser Schutz der Daten vor dem Zugriff durch Dritte ist nicht möglich.",
    dataCollection: "Datenerhebung und -verarbeitung",
    dataCollectionText: "Beim Aufrufen unserer Website werden durch Ihren Browser automatisch bestimmte Daten an unseren Server übermittelt. Diese Daten sind technisch notwendig, um die Inhalte der Website korrekt anzuzeigen. Erhobene Daten können umfassen: Browsertyp und -version, verwendetes Betriebssystem, Referrer-URL (die zuvor besuchte Seite), Hostname des zugreifenden Rechners, Uhrzeit der Serveranfrage. Aus diesen Informationen werden jedoch keine personenbezogenen Daten erhoben.",
    ipAddresses: "IP-Adressen und Protokolldateien",
    ipAddressesText: "Beim Zugriff auf unsere Website wird Ihre IP-Adresse vorübergehend in Protokolldateien gespeichert, um Angriffe (z.B. DDoS-Schutz) zu erkennen und abzuwehren. Diese Verarbeitung basiert auf unserem berechtigten Interesse an der Sicherheit und Verfügbarkeit unserer Website. Die Daten werden in der Regel nach wenigen Tagen gelöscht, sofern kein Sicherheitsvorfall vorliegt.",
    security: "Sicherheitshinweis",
    securityText: "Wir setzen technische und organisatorische Sicherheitsmaßnahmen ein, um Ihre personenbezogenen Daten gegen zufällige oder vorsätzliche Manipulationen, Verlust, Zerstörung oder den Zugriff unberechtigter Personen zu schützen. Unsere Sicherheitsmaßnahmen werden regelmäßig überprüft und entsprechend der technologischen Entwicklung verbessert.",
    advertising: "Widerspruch gegen unerwünschte Werbung",
    advertisingText: "Hiermit widersprechen wir ausdrücklich der Nutzung der im Rahmen der Impressumspflicht veröffentlichten Kontaktdaten zur Zusendung von nicht ausdrücklich angeforderter Werbung und Informationsmaterialien. Die Betreiber der Seiten behalten sich ausdrücklich rechtliche Schritte im Falle der unverlangten Zusendung von Werbeinformationen, etwa durch Spam-E-Mails, vor.",
    contactForm: "Datenschutzerklärung für das Kontaktformular",
    contactFormText: "Wenn Sie uns Anfragen über das Kontaktformular senden, werden Ihre Angaben aus dem Anfrageformular einschließlich der von Ihnen dort angegebenen Kontaktdaten von uns zur Bearbeitung der Anfrage und für den Fall von Anschlussfragen gespeichert.",
    processingScope: "Umfang der Verarbeitung personenbezogener Daten",
    processingItems: "Die von Ihnen im Formular eingegebenen Daten (z.B. Name, E-Mail-Adresse, Nachrichtentext)|Der Zeitpunkt der Übermittlung|Ihre IP-Adresse (aus Sicherheitsgründen)|Alle weiteren Informationen, die Sie freiwillig angeben",
    legalBasis: "Rechtsgrundlage",
    legalBasisText: "Die Rechtsgrundlage für die Verarbeitung Ihrer Daten über das Kontaktformular ist Ihre Einwilligung (Art. 6 Abs. 1 lit. a DSGVO), sofern Sie dieser zugestimmt haben, oder unser berechtigtes Interesse an der Beantwortung Ihrer Anfrage (Art. 6 Abs. 1 lit. f DSGVO).",
    purpose: "Zweck der Datenverarbeitung",
    purposeText: "Ihre personenbezogenen Daten werden ausschließlich zum Zweck der Beantwortung Ihrer Anfrage verarbeitet. Bei einer weiterführenden Korrespondenz können die Daten auch für diesen Zweck verwendet werden.",
    storageDuration: "Speicherdauer",
    storageDurationText: "Ihre Daten werden gelöscht, sobald sie für die Erreichung des Zwecks, für den sie erhoben und gespeichert wurden, nicht mehr erforderlich sind – in der Regel nach vollständiger Bearbeitung Ihrer Anfrage. Ausnahme: Bei gesetzlichen Aufbewahrungspflichten können Daten länger aufbewahrt werden.",
    contactDetails: "Kontaktdaten",
    contactDetailsText: "curizen GmbH, Leopoldstr. 36, 40211 Düsseldorf, Deutschland. E-Mail: info@curizen.com",
    yourRights: "Ihre Rechte als betroffene Person",
    yourRightsText: "Sie haben jederzeit das Recht, Auskunft über Ihre gespeicherten personenbezogenen Daten zu verlangen sowie das Recht auf Berichtigung, Löschung oder Einschränkung der Verarbeitung. Sie können Ihre Einwilligung zur Datenverarbeitung auch jederzeit mit Wirkung für die Zukunft widerrufen. Bitte senden Sie Ihre Anfrage an die oben genannten Kontaktdaten oder per E-Mail.",
  },
  imprint: {
    title: "Impressum",

...
export const de = {
  ...
  projects: {
    title: "Use Cases",
    addNew: "Use Case erstellen",
    search: "Use Cases suchen...",
    status: "Status",
    budget: "Budget",
    deadline: "Frist",
    ...
    fetchError: "Use Cases konnten nicht geladen werden. Bitte versuchen Sie es erneut.",
  },
  useCaseDetails: {
    backToProjects: "Zurück zu Use Cases",
  ...
  projectDetail: {
    notFound: "Use Case nicht gefunden",
    backToProjects: "Zurück zu Use Cases",
    editProject: "Use Case bearbeiten",
    projectStages: "Use Case Phasen",
    overall: "Gesamt",
  ...
  profile: {
    ...
    projectUpdated: "Persönliches Projekt erfolgreich aktualisiert",
    projectDeleted: "Persönliches Projekt erfolgreich gelöscht",
    confirmDeleteProject: "Sind Sie sicher, dass Sie dieses persönliche Projekt löschen möchten?",
    projectUrl: "Persönliche Projekt-URL",
    projectUrlPlaceholder: "z.B. https://github.com/benutzername/projekt",
    deleteFailed: "Löschen fehlgeschlagen",
    addProject: "Persönliches Projekt hinzufügen",
    projectName: "Name des persönlichen Projekts",
    projectNamePlaceholder: "Name Ihres persönlichen Projekts",
  ...
  footer: {
    ...
    skillSearcher: "Fähigkeitensucher",
    postProjects: "Use Cases erstellen",
  ...
  features: {
    ...
    ss3Title: "Modulare Use Case Abwicklung",
    ss3Desc:
    ...
    step1Desc:
      "Erstellen Sie Ihr Profil und skizzieren Sie Ihre Fähigkeiten oder reichen Sie Ihren Use Case ein.",
  ...
  terms: {
    ...
    section1Text: "Diese Nutzungsbedingungen regeln Ihre Nutzung der Sinopia-Plattform. Mit der Registrierung eines Kontos erklären Sie sich mit diesen Bedingungen einverstanden. Wenn Sie nicht einverstanden sind, nutzen Sie bitte unsere Dienste nicht.",
    section2Title: "2. Benutzerkonten",
    section2Text: "Sie müssen mindestens 18 Jahre alt sein, um ein Konto zu erstellen. Sie sind für die Geheimhaltung Ihrer Zugangsdaten und alle Aktivitäten unter Ihrem Konto verantwortlich. Bei der Registrierung müssen Sie genaue und vollständige Angaben machen.",
    section3Title: "3. Nutzung der Plattform",
    section3Text: "Sinopia bietet einen Marktplatz, der Fähigkeitengeber mit Fähigkeitensuchern verbindet. Sie erklären sich damit einverstanden, die Plattform nur für rechtmäßige Zwecke und in Übereinstimmung mit diesen Bedingungen zu nutzen. Jeglicher Missbrauch, Betrug oder Verstoß gegen geltendes Recht ist streng verboten.",
    section4Title: "4. Benutzerinhalte",
    section4Text: "Sie behalten das Eigentum an Inhalten, die Sie auf die Plattform hochladen. Durch das Hochladen gewähren Sie Sinopia eine nicht-exklusive Lizenz zur Nutzung, Anzeige und Verarbeitung Ihrer Inhalte, soweit dies für die Bereitstellung unserer Dienste erforderlich ist. Sie sind dafür verantwortlich, dass Ihre Inhalte keine Rechte Dritter verletzen.",
    section5Title: "5. Datenschutz",
    section5Text: "Ihr Datenschutz ist uns wichtig. Bitte lesen Sie unsere Datenschutzerklärung, um zu verstehen, wie wir Ihre personenbezogenen Daten erheben, verwenden und schützen. Mit der Nutzung unserer Plattform stimmen Sie unseren Datenschutzpraktiken gemäß der Datenschutzerklärung zu.",
    section6Title: "6. Zahlungen",
    section6Text: "Zahlungsbedingungen, Gebühren und Rückerstattungsrichtlinien werden vor jeder Transaktion klar kommuniziert. Sinopia kann Servicegebühren für abgeschlossene Transaktionen erheben. Alle Zahlungen werden über sichere Drittanbieter-Zahlungsdienstleister abgewickelt.",
    section7Title: "7. Haftungsausschluss",
    section7Text: "Sinopia stellt die Plattform ohne Gewährleistungen jeglicher Art zur Verfügung. Wir garantieren nicht die Richtigkeit der von Benutzern bereitgestellten Informationen oder das Ergebnis einer Zusammenarbeit zwischen Benutzern. Wir haften nicht für indirekte, zufällige oder Folgeschäden.",
  ...
  emptyState: {
    ...
    noPersonalProjects: "Keine persönlichen Projekte hinzugefügt",
  },
  status: {
    paid: "Bezahlt",
    pending: "Ausstehend",
  ...
  useCases: {
    ...
    projectOverview: "Use Case Übersicht",
    projectSummary: "Use Case Zusammenfassung",
